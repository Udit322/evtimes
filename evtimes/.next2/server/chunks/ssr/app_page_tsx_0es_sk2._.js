module.exports=[60350,a=>{"use strict";var b=a.i(87924),c=a.i(72131);let d=String.raw`<!-- TICKER -->
...
</footer>`;a.s(["default",0,function(){return(0,c.useEffect)(()=>{let a,b=Array.from(document.querySelectorAll(".cat-item")),c=document.querySelector(".nl-input"),d=document.querySelector(".btn-green-full"),e=Array.from(document.querySelectorAll(".tag-pill")),f=Array.from(document.querySelectorAll(".bar-fill")),g=f.map(a=>a.style.width),h=b.map(a=>{let c=()=>{b.forEach(a=>a.classList.remove("active")),a.classList.add("active")};return a.addEventListener("click",c),{item:a,handler:c}}),i=()=>{c&&d&&(c.value.includes("@")?(d.textContent="✓ You're subscribed!",d.style.background="var(--grn-acc)",c.disabled=!0,c.style.opacity="0.5"):(c.style.borderColor="#c0392b",c.focus(),window.setTimeout(()=>{c.style.borderColor=""},1500)))};d&&d.addEventListener("click",i);let j=e.map(a=>{let b=()=>{a.style.background="var(--grn-xlight)",a.style.borderColor="var(--grn)",a.style.color="var(--grn)"};return a.addEventListener("click",b),{pill:a,handler:b}});f.forEach(a=>{a.style.width="0"});let k=document.querySelector(".data-widget");return k&&f.length>0&&(a=new IntersectionObserver(b=>{b.forEach(b=>{b.isIntersecting&&(f.forEach((a,b)=>{window.setTimeout(()=>{a.style.width=g[b]},100*b)}),a?.disconnect())})},{threshold:.3})).observe(k),()=>{h.forEach(({item:a,handler:b})=>a.removeEventListener("click",b)),j.forEach(({pill:a,handler:b})=>a.removeEventListener("click",b)),d&&d.removeEventListener("click",i),a?.disconnect()}},[]),(0,b.jsx)("main",{dangerouslySetInnerHTML:{__html:d}})}],60350)}];

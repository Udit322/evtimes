            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[var(--brd)] pb-4">
                <div>
                  ...
                  <h2 className="mt-2 font-['Instrument_Serif'] text-[30px] leading-[1.1] text-[var(--blk)]">{item.state}</h2>
                </div>
              ...
              <div className="mt-5">
                <Link
                  href={`/city-news/${item.slug}`}
                  className="inline-flex rounded-full border border-[var(--brd)] px-4 py-2 text-xs uppercase tracking-[0.08em] text-[var(--grn)] hover:bg-[var(--grn-xlight)]"
                >
                  View details
                </Link>
              </div>

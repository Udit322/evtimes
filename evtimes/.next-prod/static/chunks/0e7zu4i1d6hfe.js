(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,31713,a=>{"use strict";var s=a.i(43476),i=a.i(71645);let e=String.raw`<!-- TICKER -->
...
</footer>`;a.s(["default",0,function(){return(0,i.useEffect)(()=>{let a,s=Array.from(document.querySelectorAll(".cat-item")),i=document.querySelector(".nl-input"),e=document.querySelector(".btn-green-full"),t=Array.from(document.querySelectorAll(".tag-pill")),n=Array.from(document.querySelectorAll(".bar-fill")),d=n.map(a=>a.style.width),r=s.map(a=>{let i=()=>{s.forEach(a=>a.classList.remove("active")),a.classList.add("active")};return a.addEventListener("click",i),{item:a,handler:i}}),l=()=>{i&&e&&(i.value.includes("@")?(e.textContent="✓ You're subscribed!",e.style.background="var(--grn-acc)",i.disabled=!0,i.style.opacity="0.5"):(i.style.borderColor="#c0392b",i.focus(),window.setTimeout(()=>{i.style.borderColor=""},1500)))};e&&e.addEventListener("click",l);let c=t.map(a=>{let s=()=>{a.style.background="var(--grn-xlight)",a.style.borderColor="var(--grn)",a.style.color="var(--grn)"};return a.addEventListener("click",s),{pill:a,handler:s}});n.forEach(a=>{a.style.width="0"});let o=document.querySelector(".data-widget");return o&&n.length>0&&(a=new IntersectionObserver(s=>{s.forEach(s=>{s.isIntersecting&&(n.forEach((a,s)=>{window.setTimeout(()=>{a.style.width=d[s]},100*s)}),a?.disconnect())})},{threshold:.3})).observe(o),()=>{r.forEach(({item:a,handler:s})=>a.removeEventListener("click",s)),c.forEach(({pill:a,handler:s})=>a.removeEventListener("click",s)),e&&e.removeEventListener("click",l),a?.disconnect()}},[]),(0,s.jsx)("main",{dangerouslySetInnerHTML:{__html:e}})}],31713)}]);